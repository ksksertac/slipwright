...
``auth_dependency`` is attached to the whole app: every route except the public ones
(login, API docs) needs a session cookie or a bearer token. When no user exists yet the
